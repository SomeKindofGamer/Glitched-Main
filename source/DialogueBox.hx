...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		else if (PlayState.SONG.song.toLowerCase() == 'tutorial' || PlayState.SONG.song.toLowerCase() == 'bopeebo')
        {
		portraitLeft = new FlxSprite(-1500, 10);
		portraitLeft.frames = Paths.getSparrowAtlas('portraits', 'shared');
		portraitLeft.animation.addByPrefix('gfPortrait', 'GF Portrait Enter instance 1', 24, false);
		portraitLeft.animation.addByPrefix('dadPortrait', 'Dad Portrait Enter instance 1', 24, false);
		...
		if (PlayerSettings.player1.controls.ACCEPT && dialogueStarted == true)
		{
			...
			if (dialogueList[1] == null && dialogueList[0] != null)
			{
				if (!isEnding)
				{
					...
					if (PlayState.SONG.song.toLowerCase() == 'senpai' || PlayState.SONG.song.toLowerCase() == 'thorns' || PlayState.SONG.song.toLowerCase() == 'tutorial' || PlayState.SONG.song.toLowerCase() == 'bopeebo')
		...
		switch (curCharacter)
		{
			case 'dadPortrait':
				...
				if (!portraitLeft.visible)
				{
					...
					portraitLeft.animation.play('dadPortrait');
				}
			case 'gfPortrait':
				portraitRight.visible = false;
				...
				{
					portraitLeft.visible = true;
					portraitLeft.animation.play('gfPortrait');
				}
			case 'bf':
				portraitLeft.visible = false;
